   ...
   if(this.isOver == true){
     fill(150); stroke(200,120,60);
      rect(this.x, this.y, this.w, this.h, 5);}
          ...
          fill(100); stroke(200,180,60);
          rect(this.x, this.y, this.w, this.h, 5);}
      
//=======================================================          
          
   if(this.active == true){
     fill(180); stroke(200,180,60);
     rect(this.x, this.y, this.w, this.h, 5);
   }
...
//=======================================================
   ...
   text(  this.label,this.x-(this.w/3),this.y+(this.h/2));

   if(recive == true){
       textAlign(RIGHT);
     fill(0); textSize(18);
     if(blink ){
   text(" |"+ message[this.id],this.x+this.w-5,this.y+(this.h/2)+5);
     }else {
      text( message[this.id],this.x+this.w-5,this.y+(this.h/2)+5); 
     }
   fill(0,255,0); 
